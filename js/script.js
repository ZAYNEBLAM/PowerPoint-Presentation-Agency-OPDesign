...
function handleSubmit(event) {
    ...
    // Here you could send formData using fetch or XMLHttpRequest
    // For demonstration, we will simply log the data to the console
    ...
    return false; // Return false to indicate the form was handled
}
